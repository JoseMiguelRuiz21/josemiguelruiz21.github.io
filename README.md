...
* Análisis y gestión de datos utilizando **SQL / Python / Excel**
* Visualización de datos y tableros interactivos usando **Power BI / Tableau**
...
### 1. Análisis de uso y segmentación para telecomunicaciones (ConnectaTel)
Análisis exploratorio de datos y segmentación de usuarios para evaluar patrones de consumo y optimizar la retención de clientes.
* **Herramientas:** Python (Pandas, NumPy, Seaborn, Matplotlib)
* [Ver repositorio del proyecto](https://github.com/JoseMiguelRuiz21/Analysis-connectatel)
